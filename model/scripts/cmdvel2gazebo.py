...
class CmdVel2Gazebo():
    def __init__(self):
        ...
        rospy.Subscriber('/mycar/cmd_vel',Twist,self.callback,queue_size=1)
        
        self.pub_steerL =rospy.Publisher('/mycar/front_left_steering_position_controller/command',Float64,queue_size=1)
        self.pub_steerR =rospy.Publisher('/mycar/front_right_steering_position_controller/command',Float64,queue_size=1)
        self.pub_rearL =rospy.Publisher('/mycar/rear_left_velocity_controller/command',Float64,queue_size=1)
        self.pub_rearR =rospy.Publisher('/mycar/rear_right_velocity_controller/command',Float64,queue_size=1)
